...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 left-10 h-32 w-32 border border-indigo-500/20 rotate-45 animate-fade-in" />
      <div className="absolute bottom-32 right-16 h-24 w-24 border border-cyan-500/15 rotate-12 animate-fade-in" style={{ animationDelay: "0.3s" }} />
      <div className="absolute top-1/3 right-1/4 h-16 w-16 border border-teal-500/15 rounded-full animate-fade-in" style={{ animationDelay: "0.5s" }} />
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        {/* Hero headline */}
        <p className="font-heading text-2xl sm:text-3xl lg:text-4xl font-semibold text-white/90 mb-6 animate-slide-up" style={{ animationDelay: "0.15s" }}>
          Build Your Next Digital Platform
        </p>

        {/* Subheading */}
        <p className="mx-auto max-w-2xl text-lg sm:text-xl text-white/60 font-body leading-relaxed mb-10 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          We build digital products and platforms for businesses and consumers —
          turning ideas into reliable, scalable technology solutions.
        </p>
        ...
        {/* Scroll hint */}
        <div className="mt-16 flex flex-col items-center gap-2 animate-fade-in" style={{ animationDelay: "1s" }}>
